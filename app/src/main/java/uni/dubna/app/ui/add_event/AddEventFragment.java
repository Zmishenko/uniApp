...
import uni.dubna.app.ui.edit_event.EditEventViewModel;
import uni.dubna.app.ui.edit_event.EditEventViewModelFactory;
...
public class AddEventFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
      //  viewModel = new EditEventViewModelFactory(new Event(), ).create(EditEventViewModel.class);
